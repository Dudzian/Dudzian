...
def decision_to_order_request(
    ...
    *,
    ...
    client_order_id_raw = source.get("client_order_id", payload.get("client_order_id"))
    client_order_id = str(client_order_id_raw).strip() if client_order_id_raw is not None else ""
