...
from typing import Any, Deque, Mapping, MutableMapping, Sequence, TYPE_CHECKING
...
if TYPE_CHECKING:
    from .meta import MetaClassifierModel
...
class DecisionModelInference:
    ...
    def score(
        ...
        *,
        ...
        if self._calibration is not None:
            prediction = self._calibration.apply(prediction)
    ...
    def _extract_calibration(
        ...
        return CalibrationReport.from_mapping(payload if isinstance(payload, Mapping) else None)
