...
class CloudAuthServiceStub(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def __init__(self, channel):
        ...
        self.AuthorizeClient = channel.unary_unary(
                '/botcore.trading.v1.CloudAuthService/AuthorizeClient',
                request_serializer=trading__pb2.CloudAuthRequest.SerializeToString,
                response_deserializer=trading__pb2.CloudAuthResponse.FromString,
                _registered_method=True)


class CloudAuthServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_CloudAuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'AuthorizeClient': grpc.unary_unary_rpc_method_handler(
                    servicer.AuthorizeClient,
                    request_deserializer=trading__pb2.CloudAuthRequest.FromString,
                    response_serializer=trading__pb2.CloudAuthResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'botcore.trading.v1.CloudAuthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('botcore.trading.v1.CloudAuthService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class CloudAuthService(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def AuthorizeClient(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/botcore.trading.v1.CloudAuthService/AuthorizeClient',
            trading__pb2.CloudAuthRequest.SerializeToString,
            trading__pb2.CloudAuthResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
