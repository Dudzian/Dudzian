        ...
        ColumnLayout {
            ...
            GridLayout {
                ...
                PerformanceComparisonPanel {
                    performanceComparison: viewModel.performanceComparison
                    Layout.fillWidth: true
                    Layout.columnSpan: 2
                }

                ScenarioTestingPanel {
                    scenarioTests: viewModel.scenarioTests
                    Layout.fillWidth: true
                    Layout.columnSpan: 2
                }

                AutomationRulesPanel {
                    automationRules: viewModel.automationRules
                    Layout.fillWidth: true
                    Layout.columnSpan: 2
                }

                CapitalAllocationPanel {
                    capitalAllocation: viewModel.capitalAllocation
                    Layout.fillWidth: true
                    Layout.columnSpan: 2
                }
                ...
                ExecutionDiagnosticsPanel {
                    executionDiagnostics: viewModel.executionDiagnostics
                    Layout.fillWidth: true
                    Layout.columnSpan: 2
                }
                ...
                MarketSentimentPanel {
                    marketSentiment: viewModel.marketSentiment
                    Layout.fillWidth: true
                    Layout.columnSpan: 2
                }

                NewsFeedPanel {
                    newsHeadlines: viewModel.newsHeadlines
                    Layout.fillWidth: true
                    Layout.columnSpan: 2
                }
                ...
                ComplianceOverviewPanel {
                    complianceSummary: viewModel.complianceSummary
                    Layout.fillWidth: true
                    Layout.columnSpan: 2
                }
