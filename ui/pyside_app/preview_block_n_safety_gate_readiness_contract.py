"""FUNCTIONAL-PREVIEW-16.6 Block N safety gate readiness contract."""
...
SCHEMA_VERSION: Final[str] = "preview_block_n_safety_gate_readiness_contract.v1"
KIND: Final[str] = "functional_preview_block_n_safety_gate_readiness_contract"
BLOCK_ID: Final[str] = "N"
STEP_ID: Final[str] = "16.6"
NEXT_STEP: Final[str] = "FUNCTIONAL-PREVIEW-16.7"
NEXT_STEP_TITLE: Final[str] = "BLOCK N SAFETY GATE READINESS READ MODEL"
READY_FOR_BLOCK_N_7: Final[bool] = True
STATUS: Final[str] = "ready_for_functional_preview_16_7_block_n_safety_gate_readiness_read_model"
SOURCE_BLOCK_N_SAFETY_GATE_READINESS_MATRIX_STEP: Final[str] = "FUNCTIONAL-PREVIEW-16.5"
READINESS_CONTRACT_STATUS: Final[str] = (
    "readiness_contract_ready_16_5_readiness_matrix_consumed_block_m_closure_preserved_"
    "block_n_opened_exe_direction_preserved_source_only_plain_data_static_contract_only_"
    "all_capabilities_contracted_all_execution_capabilities_not_ready_"
    "all_execution_capabilities_blocked_all_requirements_missing_all_execution_unauthorized_"
    "all_gates_closed_invariants_preserved_no_gate_evaluation_no_validation_"
    "no_confirmation_acceptance_no_authorization_no_packaging_no_build_no_release_no_runtime_"
...
_FALSE_BY_16_6_ROOTS: Final[list[str]] = [
    "gate_evaluated",
    "gate_condition_met",
    "gate_opened",
    "gate_state_mutated",
...
def build_preview_block_n_safety_gate_readiness_contract() -> dict[str, Any]:
    """Build the 16.6 source-only, plain-data readiness contract."""
    matrix = build_preview_block_n_safety_gate_readiness_matrix()
    packaging_rows = _build_capability_contract_rows(
        matrix["packaging_release_readiness_rows"], "packaging_release", PACKAGING_REQUIREMENTS
    )
    runtime_rows = _build_capability_contract_rows(
        matrix["runtime_safety_readiness_rows"], "runtime_safety", RUNTIME_REQUIREMENTS
    )
    invariant_rows = _build_invariant_contract_rows(matrix["cross_domain_invariant_readiness_rows"])
    requirement_rows = _build_requirement_contract_rows(matrix["validation_requirement_rows"])
    payload: dict[str, Any] = {
        "schema_version": SCHEMA_VERSION,
        "block_n_safety_gate_readiness_contract_kind": KIND,
        "block": BLOCK_ID,
        "step": STEP_ID,
        "block_n_safety_gate_readiness_contract_status": READINESS_CONTRACT_STATUS,
        "block_n_safety_gate_readiness_contract_decision": READINESS_CONTRACT_DECISION,
        "ready_for_block_n_7": READY_FOR_BLOCK_N_7,
        "next_step": NEXT_STEP,
        "next_step_title": NEXT_STEP_TITLE,
        "block_n_safety_gate_readiness_matrix_reference": _build_matrix_reference(matrix),
        "readiness_contract_summary": _build_summary(),
        "packaging_release_readiness_contract_rows": packaging_rows,
        "runtime_safety_readiness_contract_rows": runtime_rows,
        "cross_domain_invariant_readiness_contract_rows": invariant_rows,
        "validation_requirement_contract_rows": requirement_rows,
        "domain_readiness_contract_summary": _build_domain_summary(packaging_rows, runtime_rows),
        "exe_direction_readiness_contract": _build_exe_direction_contract(matrix),
        "fail_closed_readiness_contract_decision": _build_fail_closed_decision(),
        "non_execution_contract_evidence": _build_non_execution_evidence(),
        "readiness_contract_boundaries": _build_readiness_contract_boundaries(),
        "source_boundaries": _build_source_boundaries(matrix),
        "future_steps": ["functional_preview_16_7_block_n_safety_gate_readiness_read_model"],
        "status": STATUS,
    }
...
def _build_matrix_reference(matrix: dict[str, Any]) -> dict[str, Any]:
    ...
    reference.update(
        {
            "source_block_n_safety_gate_readiness_matrix_step": SOURCE_BLOCK_N_SAFETY_GATE_READINESS_MATRIX_STEP,
            "source_block_n_safety_gate_readiness_matrix_read_by_16_6": True,
            "block_n_safety_gate_readiness_matrix_available_before_contract": True,
            "static_block_n_safety_gate_readiness_matrix_only": True,
            "block_n_safety_gate_readiness_contract_built_by_16_6": True,
            "ready_for_functional_preview_16_7": True,
        }
    )
    for root in _FALSE_BY_16_6_ROOTS:
        reference[root + "_by_16_6"] = False
    return reference
...
def _build_capability_contract_rows(
    source_rows: list[dict[str, Any]], domain: str, requirements: list[str]
) -> list[dict[str, Any]]:
    return [
        {
            "contract_row_id": row["readiness_row_id"] + "_contract",
            ...
            "source_matrix_result": "not_ready_missing_requirements_execution_blocked",
            "source_static_readiness_classification": "not_ready",
            "contract_required_requirements": list(requirements),
            "contract_satisfied_requirements": [],
            "contract_missing_requirements": list(requirements),
            "contract_requirements_total": 4,
            "contract_requirements_satisfied_count": 0,
            "contract_requirements_missing_count": 4,
            "contract_requirements_complete": False,
            "contract_readiness_classification": "not_ready",
            "contract_ready_for_execution": False,
            "contract_execution_authorized": False,
            "contract_gate_open_now": False,
            "contract_execution_allowed_now": False,
            "contract_execution_performed_now": False,
            "contract_requires_future_explicit_gate": True,
            "contract_failure_policy": "fail_closed",
            "contract_result": "contracted_not_ready_missing_requirements_execution_blocked",
            "notes": "16.6 contracts the 16.5 not-ready row without evaluation or execution.",
        }
        for row in source_rows
    ]


def _build_invariant_contract_rows(source_rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    return [
        {
            "contract_row_id": row["readiness_row_id"] + "_contract",
            "source_readiness_row_id": row["readiness_row_id"],
            ...
            "domain": "cross_domain",
            "display_name": row["display_name"],
            "source_matrix_result": "invariant_preserved_execution_blocked",
            "source_static_readiness_classification": "invariant_preserved_execution_not_ready",
            "source_invariant_preserved": True,
            "contract_invariant_preserved": True,
            "contract_invariant_required_for_future_execution": True,
            "contract_execution_gate_open_now": False,
            "contract_execution_allowed_now": False,
            "contract_execution_performed_now": False,
            "contract_requires_future_explicit_gate": True,
            "contract_readiness_classification": "invariant_preserved_execution_not_ready",
            "contract_failure_policy": "fail_closed",
            "contract_result": "contracted_invariant_preserved_execution_blocked",
            "notes": "16.6 preserves the 16.5 invariant classification without opening execution.",
        }
        for row in source_rows
    ]


def _build_requirement_contract_rows(source_rows: list[dict[str, Any]]) -> list[dict[str, Any]]:
    return [
        {
            "contract_row_id": row["requirement_id"] + "_readiness_contract",
            ...
            "contract_missing_blocks_execution": True,
            "contract_requires_future_explicit_step": True,
            "contract_failure_policy": "fail_closed",
            "contract_result": "contracted_missing_execution_blocked",
            "notes": "16.6 contracts the 16.5 missing requirement without validation.",
        }
        for row in source_rows
    ]
...
def _domain_row(domain: str, count: int, required: list[str]) -> dict[str, Any]:
    return {
        ...
        "contracted_capability_count": count,
        "ready_capability_count": 0,
        ...
        "domain_ready": False,
        "execution_authorized": False,
        "all_capabilities_contracted": True,
        "all_capabilities_not_ready": True,
        "all_capabilities_blocked": True,
        "failure_policy": "fail_closed",
        "contract_result": "contracted_not_ready_execution_blocked",
...
def _build_exe_direction_contract(matrix: dict[str, Any]) -> dict[str, Any]:
    contract = dict(matrix["exe_direction_readiness_matrix"])
    contract.update(
        {
...
def _build_fail_closed_decision() -> dict[str, Any]:
    ...
    return {
        "missing_block_n_safety_gate_readiness_matrix_policy": "fail_closed",
        "missing_readiness_contract_row_policy": "fail_closed",
        "missing_requirement_contract_row_policy": "fail_closed",
        "missing_invariant_contract_row_policy": "fail_closed",
        ...
        "block_n_safety_gate_readiness_contract_in_16_6": "ready",
        "block_n_safety_gate_readiness_read_model_in_16_7": "allowed",
        "only_source_only_16_7_handoff_allowed": True,
...
def _build_readiness_contract_boundaries() -> dict[str, bool]:
    true_keys = [
        "block_n_safety_gate_readiness_contract_is_plain_data_only",
        "block_n_safety_gate_readiness_contract_is_source_only",
        "block_n_safety_gate_readiness_contract_reads_readiness_matrix_only",
        "block_n_safety_gate_readiness_contract_preserves_block_m_closure",
        "block_n_safety_gate_readiness_contract_preserves_block_n_entry",
        "block_n_safety_gate_readiness_contract_preserves_exe_direction_without_packaging",
        "block_n_safety_gate_readiness_contract_is_static_and_non_evaluating",
        "block_n_safety_gate_readiness_contract_is_non_mutating",
        "block_n_safety_gate_readiness_contract_is_non_authorizing",
        "block_n_safety_gate_readiness_contract_can_feed_16_7_read_model",
...
def _build_source_boundaries(matrix: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "source_block_n_safety_gate_readiness_matrix": SOURCE_BLOCK_N_SAFETY_GATE_READINESS_MATRIX_STEP,
        "source_block_n_safety_gate_read_model": source["source_block_n_safety_gate_read_model"],
        "source_block_n_safety_gate_readiness_matrix_boundaries": {
            "allowed_imports_only": source["allowed_imports_only"],
            "source_block_n_safety_gate_read_model": source[
