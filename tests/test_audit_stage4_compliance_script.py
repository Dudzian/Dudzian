...
def _write_config(
    ...
    *,
    ...
    key_rotation_registry: str | None = None,
) -> Path:
    config_dir = tmp_path
    ...
    if key_rotation_registry is None:
        key_rotation_registry = "var/security/key_rotation.json"
    ...
    config = {
        ...
        "observability": {
            ...
            "key_rotation": {
                "registry_path": key_rotation_registry,
