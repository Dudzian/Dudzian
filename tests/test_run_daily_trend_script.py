...
def test_render_smoke_summary_with_metrics() -> None:
    ...
    assert "Instrumenty: BTCUSDT: zlecenia 3, wolumen 2 222.10, opłaty 0.9877" in text
    assert "ETHUSDT: zlecenia 1, wolumen 500.00, opłaty 0.1234, netto +0.2500, wartość 125.00" in text
