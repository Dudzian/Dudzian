...
from bot_core.exchanges.bitget import BitgetSpotAdapter
...
def test_bitget_spot_rate_limit(monkeypatch, rate_limiter_registry):
    ...
    adapter = BitgetSpotAdapter(
        ...
        settings={
            ...
            "rate_limit_rules": (RateLimitRule(rate=60, per=60.0),),
        },
        client=client,
    )
