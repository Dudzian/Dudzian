"""Testy CLI verify_stage5_hypercare_summary."""
...
from scripts import verify_stage5_hypercare_summary
...
def test_cli_handles_structural_error(tmp_path: Path, capsys: pytest.CaptureFixture[str]) -> None:
    ...
    exit_code = verify_stage5_hypercare_summary.run([str(summary_path)])
