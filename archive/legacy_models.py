...
try:
    ...
    class _TorchModule:  # pragma: no cover - tylko fallback importowy
        def __init__(self, *args, **kwargs) -> None:  # noqa: D401
            raise RuntimeError("PyTorch nie jest dostępny w środowisku wykonawczym")
    ...
    nn = types.SimpleNamespace(Module=_TorchModule)  # type: ignore[assignment]
    F = types.SimpleNamespace()  # type: ignore[assignment]
    Dataset = type("Dataset", (), {})  # type: ignore[assignment]
    DataLoader = type("DataLoader", (), {})  # type: ignore[assignment]
