...
5. Automatyzacja CI/CD, szkolenie operatorów oraz testy obciążeniowe z raportem wydajności; przygotowanie planu wejścia w kolejny etap (materiały Stage5 znajdują się jedynie w `archive/hypercare_stage5` jako referencja historyczna, poza aktywnym Stage6).
