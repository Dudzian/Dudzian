...
```json
{
  ...
  "frozen_inputs": {
    ...
    "root_proof_issuer": "INDEPENDENT_PRE_ACCOUNT_ROOT_PROOF_ISSUER",
    "root_proof_validator": "CHA admission validation role (implementation unavailable)",
    "root_proof_consumption_semantics": "C_STATEFUL_SINGLE_BIND_AT_ISSUANCE_PLUS_IMMUTABLE_EXACT_OPERATION_PROOF",
    "genesis_final_decision_owner": "CryptoHunterAccountAuthority",
  ...
  "existing_candidate_inventory": {
    ...
    "root_proof_validation_receipt": {
      "object": "SEPARATE_VALIDATION_RECEIPT_NOT_REQUIRED",
      "replacement": "RootProofAdmissionEvidenceV1"
    },
    "AccountGenesis_admission_evidence": {
      "object": "RootProofAdmissionEvidenceV1",
      "availability": "SEMANTICS_FROZEN / IMPLEMENTATION_NOT_AVAILABLE"
    }
  },
  "proof_object_layers": {
    "raw_external_claim": {
    ...
    "root_proof_validation_receipt": {
      "object": "SEPARATE_VALIDATION_RECEIPT_NOT_REQUIRED",
      "replacement": "RootProofAdmissionEvidenceV1",
      "must_not_be_fabricated_from": "public SHA, local HMAC, structural validity, current membership fallback, current issuer state alone or caller proof alone"
    },
    "AccountGenesis_admission_evidence": {
      "object": "RootProofAdmissionEvidenceV1",
      "owner": "CryptoHunterAccountAuthority local AccountGenesis authority record",
      "requirement": "atomically retain exact validation, root-proof, claimant, requester, entitlement BOUND history and INITIAL_BINDING provenance in PREPARED"
    }
  },
  "candidate_models": {
    ...
    "C_EXTERNAL_ISSUER_ACCOUNT_GENESIS_PROOF": {
      "status": "SELECTED_SEMANTICS_FROZEN_IMPLEMENTATION_UNAVAILABLE",
  ...
  "selected_or_blocked_model": {
    "selection": "C_EXTERNAL_ISSUER_ACCOUNT_GENESIS_PROOF",
    ...
    "semantic_status": "SEMANTICS_FROZEN",
    "implementation_status": "PRODUCTION_ISSUER_ENTITLEMENT_AND_CLAIMANT_AUTHORITY_NOT_AVAILABLE"
  },
  ...
  "account_binding": {
    ...
    "options": {
      ...
      "B_direct_exact_account_id": "SELECTED: independent issuer proof exact binding",
      "C_atomic_proof_reservation": "POSSIBLE_NOT_SELECTED",
      "D_NOT_FROZEN": "NOT_SELECTED"
    },
    "mismatch_rule": "Proof account_id MUST exactly equal INITIAL_BINDING account_id; mismatch REJECT.",
  ...
  "operation_binding": {
    "proof_id_is_operation_id": false,
    "current_candidate_binds_logical_operation": true,
    "current_candidate_binds_reservation": true,
    "current_candidate_binds_canonical_genesis_request": true,
    "future_requirement": "SATISFIED_BY_INDEPENDENT_ISSUER_CONTRACT",
    "changed_semantics_rule": "different operation, account, request fingerprint, or INITIAL_BINDING tuple is REJECT",
    "status": "FROZEN",
    "issuance_timing": "B_AFTER_INITIAL_BINDING_BEFORE_PREPARED"
  },
  "environment_binding": {
  ...
  "validation_semantics": {
    "valid_root_proof_means": "Prerequisite evidence from the frozen independent issuer contract, exact-bound to authoritative INITIAL_BINDING account, operation, request and entitlement.",
    "does_not_prove": [
    ...
    "proof_validated_is_freshness": false
  },
  "validation_output": {
    "model": "NO_SEPARATE_EXTERNAL_VALIDATION_AUTHORITY_OR_RECEIPT",
    "separate_validation_receipt": "SEPARATE_VALIDATION_RECEIPT_NOT_REQUIRED",
    "object": "RootProofAdmissionEvidenceV1",
    "owner": "CryptoHunterAccountAuthority local AccountGenesis authority record",
    "semantic_role": "durable subordinate CHA record that exact validation succeeded for one INITIAL_BINDING and is ACCEPTED_FOR_PREPARED_ONLY",
    "is_new_root_of_trust": false,
    "is_new_semantic_authority": false,
    "is_freshness_evidence": false,
    "is_issuer_decision": false,
    "implies_COMMITTED": false,
    "implies_freshness": false,
    "fields": [
      "schema_version",
      "environment",
      "trust_domain",
    ...
    "validation_outcome": "ACCEPTED_FOR_PREPARED_ONLY",
    "timestamps_are_authority": false,
    "claimant_binding_model": "AUTHORITATIVE_INDIRECT via exact entitlement id/generation and BOUND history; evidence retains claimant principal/key binding",
    "persistence": "atomically stored with PREPARED under dedicated AccountGenesis local authority integrity/custody boundary; partial PREPARED impossible",
    "minted_by_issuer": false,
    "minted_by_FreshnessAuthority": false,
    "winning_attempt_rule": "must reference exact actual issuer BOUND winner, its requester/claimant key versions, authoritative BOUND history and exact proof; never newest-local preference",
    "winning_attempt_digest_semantics": {
      "field": "winning_root_proof_issuance_attempt_digest_sha256",
      "exact_meaning": "SHA-256 immutable RootProofIssuanceAttemptIdentityPayloadV1 digest under CRYPTOHUNTER_ACCOUNT_GENESIS_ROOT_PROOF_ISSUANCE_ATTEMPT_IDENTITY_V1",
      "forbidden_meanings": [
      ...
      "consistency": "winning attempt ID + immutable identity digest + authoritative BOUND history + exact root proof MUST mutually match"
    },
    "winning_attempt_end_to_end_consistency": {
      "admission_winning_attempt_id": "MUST equal issuer_history.bound_issuance_attempt_id",
      "local_attempt_id": "MUST equal admission and issuer history ID",
      "immutable_digest": "MUST resolve the local immutable identity payload for that exact ID",
      "signed_request_identity": "MUST exactly match issuer-retained signed RootProofIssuanceRequest identity; semantic equivalence is insufficient",
      "bound_history_and_root_proof": "MUST bind the same issuance_attempt_id",
      "mismatch": "FAIL_CLOSED / CORRUPTION_OR_TAMPER",
      "current_pointer_is_authoritative": false
    }
  },
  "consumption_semantics": {
    "model": "C_STATEFUL_SINGLE_BIND_AT_ISSUANCE_PLUS_IMMUTABLE_EXACT_OPERATION_PROOF",
    "single_use": true,
    "multi_use": false,
    "max_logical_operations": 1,
    "max_account_ids": 1,
    "account_bound": true,
    "operation_bound": true,
    "request_fingerprint_bound": true,
    "entitlement_transition": "issuer-owned globally serialized UNBOUND -> BOUND(exact tuple, proof identity, signing key version)",
    "exact_same_tuple_retry": "IDEMPOTENT_SAME_PROOF_BYTES",
    "different_tuple": "REJECT",
    "post_issuance_CONSUMED_state": false,
    "post_issuance_issuer_callback": false,
    "source_of_truth": "m05_account_genesis_independent_root_proof_issuer_contract.json"
  },
  "replay": {
    "R_to_O1_acct_A_then_O2_acct_B": "REJECT",
    "one_external_R_validated_twice": "ONLY exact same tuple retry; idempotent same proof and same terminal operation",
    "same_proof_same_logical_operation_retry": "IDEMPOTENT_SAME_PROOF; MUST NOT create a second account",
    "same_proof_changed_semantic_request": "REJECT",
    "entitlement_second_independent_operation": "REJECT",
    "post_issuance_consumption": "NONE"
  },
  "historical_provenance": {
    ...
    "current_availability": "SEMANTICS_FROZEN / IMPLEMENTATION_NOT_AVAILABLE",
  ...
  "authority_boundary": {
    ...
    "issuer": "IndependentAccountGenesisRootProofIssuer",
    "validator_options": {
      "A_CHA_SUBORDINATE_VALIDATION_CAPABILITY": "SELECTED",
      "B_SEPARATE_VALIDATION_AUTHORITY": "NOT_SELECTED"
    },
    "validator_owner": "CryptoHunterAccountAuthority",
    "genesis_final_decision_owner": "CryptoHunterAccountAuthority",
    ...
    "root_proof_validation_is_subordinate": true,
    "admission_evidence_is_genesis_decision": false
  },
  "failure_semantics": {
  ...
  "root_proof_capability_matrix": {
    ...
    "operation binding": {
      "status": "AVAILABLE",
      "evidence": "frozen independent issuer proof binds exact logical operation"
    },
    "request-semantic binding": {
      "status": "AVAILABLE",
      "evidence": "frozen proof binds canonical request fingerprint"
    },
    "environment binding": {
      "status": "NOT_AVAILABLE",
    ...
    "replay semantics": {
      "status": "AVAILABLE",
      "evidence": "Model C exact-tuple bind/retry/reject semantics frozen"
    },
  ...
  "cross_artifact_parity": {
    ...
    "subject_cardinality": "NOT_FROZEN",
    "same_proof_replay_semantics": "IDEMPOTENT_EXACT_TUPLE_ONLY",
    "M03_FirstRunBootstrapAuthority_scope": "INITIAL_SECURITY_ESTABLISHMENT_ONLY",
    "M03_membership_equals_genesis_authority": false,
    "consumption_model": "C_STATEFUL_SINGLE_BIND_AT_ISSUANCE_PLUS_IMMUTABLE_EXACT_OPERATION_PROOF",
    "issuance_timing": "B_AFTER_INITIAL_BINDING_BEFORE_PREPARED",
    "account_binding": true,
    "operation_binding": true,
    "request_fingerprint_binding": true,
    "entitlement_max_operations": 1,
    "entitlement_max_accounts": 1,
    "post_issuance_CONSUMED_state": false,
    "validation_success": "PREREQUISITE_EVIDENCE_ONLY",
    "issuer_implementation_available": false
  },
  "mandatory_redteam": {
  ...
  "result": {
    "primary_result": "ACCOUNT_GENESIS_ROOT_PROOF_ISSUER_CONTRACT_CAN_BE_FROZEN",
    "semantic_status": "SEMANTICS_FROZEN",
    "production_status": "PRODUCTION_ISSUER_ENTITLEMENT_AND_CLAIMANT_AUTHORITY_NOT_AVAILABLE",
    "formal_advancement": "WITHHELD",
    "reason": "Admission semantics are frozen and share Model C with the independent issuer contract; production issuer, entitlement, claimant authority, custody and retained registry remain unavailable."
  },
  ...
  "preserved_status": {
    ...
    "root-proof issuer": "SEMANTICS_FROZEN_IMPLEMENTATION_NOT_AVAILABLE",
    "root-proof validator": "SEMANTICS_FROZEN_IMPLEMENTATION_NOT_AVAILABLE",
    "root-proof consumption semantics": "C_STATEFUL_SINGLE_BIND_AT_ISSUANCE_PLUS_IMMUTABLE_EXACT_OPERATION_PROOF",
    "genesis final decision owner": "CryptoHunterAccountAuthority",
  ...
  "admission_recovery": {
    "continue_PREPARED_only_if": "durable RootProofAdmissionEvidenceV1 exactly matches current operation, account, request, INITIAL_BINDING, root proof, issuer history decision, entitlement generation/bound tuple, claimant and requester",
    "missing_or_mismatch": "FAIL_CLOSED",
    "forbidden_reconstruction_sources": [
      "current issuer state alone",
      "caller-supplied proof alone",
      "root_proof_id alone",
      "current entitlement lookup alone",
      "local projection"
    ],
    "caller_may_reconstruct_missing_evidence": false,
    "current_issuer_state_substitutes_retained_history": false,
    "VERIFY_ONLY_after_normal_rotation": "historical verification allowed when credential was eligible at issuance/validation and retained evidence matches",
    "compromise_REVOKED": "requires independent retained-history and trusted-checkpoint evidence; missing trustworthy history FAIL_CLOSED",
    "winning_attempt": "actual authoritative BOUND attempt controls recovery and PREPARED evidence, even when a newer local superseding attempt exists"
  },
  "admission_evidence_redteam_mutations": [
    "prepared_root_proof_id_only",
    ...
    "validation_output_design_blocked",
