            ...
            "explicit_m05_source_venue_execution_environment_identity_migration_design": {
              ...
              "downstream_impact_audit": [
                ...
                },
                {
                  ...
                  "classification": "SEMANTIC_MIGRATION_REQUIRED",
              ...
              "m02_m06_compatibility": {
                "M0.2": {
                  ...
                  "instrument_identity_dimensions": {
                    ...
                    "authoritative_m05_cutover_blocked_until_migrated": true
                  }
                },
                "M0.6": {
                  ...
                  "instrument_environment_exchange_checks": "SEMANTIC_MIGRATION_REQUIRED",
                  "exact_evidence": [
                    "InstrumentProjection required fields include exchange_id and environment",
                    "environment_registry binds InstrumentProjection.environment",
                    "trusted context requires route/catalog/account exact exchange/environment scope"
                  ],
                  "migration_rule": "Remove source Instrument environment equality; compare source_exchange_id only for source facts and execution exchange/environment only across account/route/order/lease contexts."
                }
              },
              "m02_identity_dimensions_migration_dependency": {
                "status": "MIGRATION_REQUIRED_DESIGN_ONLY_NOT_IMPLEMENTED",
