...
**Raport zamknięcia:** patrz [Raport zamknięcia Etapu 4](stage4_final_report.md). Rozszerzony zakres opisano w [Specyfikacji Etapu 4](stage4_spec.md); materiały piątego etapu pozostają wyłącznie w archiwum (`archive/hypercare_stage5`) i nie są częścią aktywnego Stage6.
