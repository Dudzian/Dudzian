...
3. **Narzędzia operacyjne** (35 min)
  ...
  - Migrację zaszyfrowanych plików `SecurityManager` należy przeprowadzić narzędziem opisanym w [docs/migrations/2024-stage5-storage-removal.md](../migrations/2024-stage5-storage-removal.md) – runtime nie wspiera już odczytu tych plików.
