...
* Kontrolery korzystają z `UISettingsStore` (`core/config/ui_settings.py`). Pliki `var/state/ui_settings.json` nie są już ładowane – aplikacja loguje komunikat o koniecznej migracji opisanej w [docs/migrations/2024-historical-storage-removal.md](../migrations/2024-historical-storage-removal.md).
