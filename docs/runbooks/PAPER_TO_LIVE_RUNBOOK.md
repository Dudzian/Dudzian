...
> **Uwaga:** `python scripts/lint_paths.py` kończy się błędem, gdy wykryje zakazane katalogi legacy (prefiksy Stage5) lub pliki wykonywalne w `archive/**`. Usuń pozostałości zanim przejdziesz dalej – ostrzeżenia nie są już dopuszczane.
