...
1. **Aktywacja**
   ...
   - Pliki w historycznym formacie (czysty base64) są blokowane błędem „Sekret licencji ma nieobsługiwany historyczny format”. Zastosuj narzędzie `python -m dudzian_migrate.license_secret` zgodnie z [docs/migrations/2024-historical-storage-removal.md](../migrations/2024-historical-storage-removal.md).
