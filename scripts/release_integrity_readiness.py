...
def build_payload(mode: str) -> tuple[dict[str, object], int]:
    ...
    issues.extend(
        [
            "promotion_gate_not_performed",
            "rc_to_ga_promotion_not_ready",
    ...
    readiness = {
        ...
        "promotion_gate_policy_present": True,
        "promotion_gate_policy_version": "release_promotion_gate_policy.v1",
        "promotion_gate_performed": False,
        "promotion_gate_result": "not_performed",
        "rc_to_ga_promotion_performed": False,
        "rc_to_ga_promotion_ready": False,
        "rc_to_ga_blockers": [
            "security_manifest_not_clean",
            "known_release_blockers_present",
            "hash_manifest_not_generated",
            "final_artifact_scan_not_performed",
            "release_signing_not_ready",
            "release_notes_not_attached",
            "source_commit_not_confirmed",
            "build_id_not_assigned",
            "reproducible_build_record_not_attached",
        ],
        "rc_to_ga_requires_clean_security_manifest": True,
        "rc_to_ga_requires_no_known_blockers": True,
        "rc_to_ga_requires_hash_manifest": True,
        "rc_to_ga_requires_final_artifact_scan": True,
        "rc_to_ga_requires_signing": True,
        "rc_to_ga_requires_release_notes": True,
        "rc_to_ga_requires_source_commit": True,
        "rc_to_ga_requires_build_id": True,
        "rc_to_ga_requires_reproducible_build_record": True,
        "rc_to_ga_is_prebuild_policy_only": True,
