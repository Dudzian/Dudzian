    ...
    sections: dict[str, dict[str, Any]] = {
        ...
        "data_source_market_feed": {
            ...
            "gaps": [
                ...
                "Local scenario runner can produce deterministic context-only dry-run decision artifact after execution; dry-run artifact is context-only and generates no orders/decisions, with no scoring, no recommendation, no strategy engine, AI/model inference, DecisionEnvelope integration, or TradingController integration.",
