...
def build_report() -> dict[str, Any]:
    ...
    sections: dict[str, dict[str, Any]] = {
        "preview_mode_contract": {
            ...
            "evidence_files": _existing(
                [
                    ...
                    "bot_core/runtime/paper_preview_runtime_service_closure.py",
                    "bot_core/runtime/paper_preview_runtime_service_read_api.py",
                    "bot_core/runtime/paper_preview_runtime_service_history.py",
                    "bot_core/runtime/paper_preview_runtime_service_read_api_boundary.py",
                    "bot_core/runtime/paper_preview_runtime_service_refusal_executor.py",
                    "bot_core/runtime/paper_preview_runtime_service_boundary.py",
                    "bot_core/runtime/paper_preview_runtime_service_lifecycle.py",
            ...
            "gaps": [
                ...
                "Local scenario runner can carry deterministic read-only market context from in-memory/static-local fixtures and can produce a deterministic local context/artifact/audit bundle plus fail-closed bundle boundary/export refusal and local bundle boundary matrix, and local read model can summarize bundle + boundary matrix for future UI/runtime integration; read model boundary matrix refuses QML/PySide/UI/runtime/export/cloud/engine boundaries without treating it as live account/balance/order access and with no generated orders/decisions, no scoring, no recommendation, no DecisionEnvelope integration, and no TradingController integration; bundle boundary matrix shows all export/serialization/cloud/engine handoff boundaries are refused; matrix/report/read model is local/static-only; read model is not QML/PySide/UI-bound; read model is not runtime-backed; file export, serialization export, cloud sink, external export, and engine handoff remain refused. Local read API boundary/no-export matrix is partial/static-local evidence that refuses UI binding, runtime/lifecycle execution, command dispatcher, decision/order, live/account/secret, serialization/export/cloud boundaries without turning the read API into UI binding, serializer, exporter, or command executor. BLOK C now maps PreviewReadOnlyBindingSnapshot into controlled read-only UI state values copied from static-local BLOK B closure evidence; BLOK C now has a read-only PySide bridge preflight for blockCReadOnlyBindingState; bridge exposes controlled read-only state as copy-on-read QVariantMap; bridge state passes the no-action boundary matrix; BLOK C QML panel now consumes controlled read-only UI state values with safe blocked/false/none/zero fallbacks; BLOK C now has a read-only UI state boundary/no-action matrix; matrix refuses action handlers, command dispatch, lifecycle execution, runtime loop, scheduler/worker, order generation/submission, decision/controller paths, export/cloud, live/testnet/account/secret boundaries; controlled UI state remains static-local and read-only; the state does not expose commands/actions/export/live/testnet/account/secret handles; QML/source proof remains read-only and the static-local UI read-only binding contract exposes only immutable BLOK B closure/read API summary fields; no actions, command dispatch, lifecycle execution, runtime loop, export/cloud, live/testnet/account/secret paths are exposed; UI proof does not start runtime loop, execute commands, submit orders, serialize/export, fetch live/testnet data, read accounts/secrets, or mutate runtime state; integration gate remains blocked and ready_for_ui_runtime_integration remains false.",
            ],
            "recommended_next_step": "Keep the static mode contract and enforcement helper as the foundation that allows paper/testnet/read-only/recorded capabilities while blocking live-production capabilities; the local scenario runner can carry deterministic read-only market context from in-memory/static-local fixtures, READ_ONLY_MARKET_FETCH remains preview-safe, and account/balance/credentials/order/fill/live side effects remain blocked; no real market adapter/fetch yet, no app runtime loop, UI integration, testnet/sandbox adapter, file export, serialization export, cloud sink, external export, serialization payload, or engine handoff exists yet. Local runtime service wrapper boundary/no-loop matrix refuses runtime loop, scheduler/worker/background, UI binding, controller, decision, export/cloud, live and adapter boundaries; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Lifecycle command contract allows only local/static/single-shot introspection/composition commands; runtime loop, scheduler/worker/background, UI binding, controller, decision, export/cloud, live and adapter commands remain refused; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Local read API boundary/no-export matrix refuses UI binding, runtime/lifecycle execution, command dispatcher, decision/order, live/account/secret, serialization/export/cloud boundaries; read API remains immutable in-memory projection only; read API does not serialize/export/write files/open sockets; read API does not execute lifecycle commands; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Local refusal executor proof returns controlled refusals/static acknowledgements without executing commands; refused UI binding, runtime/lifecycle execution, command dispatcher, decision/order, live/account/secret, serialization/export/cloud attempts remain non-executed; read API remains immutable in-memory projection only; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Service snapshot history contract keeps a bounded immutable in-memory history of already-built read API evidence; history does not collect in background, run loops, serialize/export/write files/open sockets, or execute commands; refusal executor proof remains non-executing; read API remains immutable in-memory projection only; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. BLOK B local runtime service wrapper is contract-complete for static-local evidence; closure audit aggregates service snapshot, boundary matrix, lifecycle command contract, read API, read API boundary/no-export matrix, refusal executor proof, and bounded in-memory history; closure audit confirms ready_for_block_c=True; closure audit keeps ready_for_ui_runtime_integration=False, ready_for_decision_engine=False, ready_for_export=False, ready_for_live=False; integration gate remains blocked; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter; BLOK C has controlled read-only UI state proof mapped from PreviewReadOnlyBindingSnapshot plus a read-only UI state boundary/no-action matrix and read-only PySide bridge preflight for blockCReadOnlyBindingState; next step should be bridge refusal/negative controls or read-only bridge smoke in PySide-enabled CI, still without actions.",
        },
        ...
        "ai_decision_governor": {
            ...
            "gaps": [
                ...
                "Market context is in-memory/static-local fixture only; no real market adapter/fetch yet, no app runtime loop, UI integration, testnet/sandbox adapter, file export, serialization export, cloud sink, external export, serialization payload, or engine handoff exists yet. Local runtime service wrapper boundary/no-loop matrix refuses runtime loop, scheduler/worker/background, UI binding, controller, decision, export/cloud, live and adapter boundaries; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Lifecycle command contract allows only local/static/single-shot introspection/composition commands; runtime loop, scheduler/worker/background, UI binding, controller, decision, export/cloud, live and adapter commands remain refused; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Local read API boundary/no-export matrix refuses UI binding, runtime/lifecycle execution, command dispatcher, decision/order, live/account/secret, serialization/export/cloud boundaries; read API remains immutable in-memory projection only; read API does not serialize/export/write files/open sockets; read API does not execute lifecycle commands; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Local refusal executor proof returns controlled refusals/static acknowledgements without executing commands; refused UI binding, runtime/lifecycle execution, command dispatcher, decision/order, live/account/secret, serialization/export/cloud attempts remain non-executed; read API remains immutable in-memory projection only; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Service snapshot history contract keeps a bounded immutable in-memory history of already-built read API evidence; history does not collect in background, run loops, serialize/export/write files/open sockets, or execute commands; refusal executor proof remains non-executing; read API remains immutable in-memory projection only; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. BLOK B local runtime service wrapper is contract-complete for static-local evidence; closure audit aggregates service snapshot, boundary matrix, lifecycle command contract, read API, read API boundary/no-export matrix, refusal executor proof, and bounded in-memory history; closure audit confirms ready_for_block_c=True; closure audit keeps ready_for_ui_runtime_integration=False, ready_for_decision_engine=False, ready_for_export=False, ready_for_live=False; integration gate remains blocked; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter; next block should be BLOK C — UI READ-ONLY BINDING.",
            ],
        ...
        "paper_terminal_order_lifecycle": {
            ...
            "paper_only_execution_safe": True,
            "gaps": [
                "Local paper event spine exists with deterministic accepted, rejected, partial fill, fill, and cancel unit-level lifecycle tests and no live exchange/order/account side effects. Local runtime service wrapper boundary/no-loop matrix refuses runtime loop, scheduler/worker/background, UI binding, controller, decision, export/cloud, live and adapter boundaries; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Lifecycle command contract allows only local/static/single-shot introspection/composition commands; runtime loop, scheduler/worker/background, UI binding, controller, decision, export/cloud, live and adapter commands remain refused; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Local read API boundary/no-export matrix refuses UI binding, runtime/lifecycle execution, command dispatcher, decision/order, live/account/secret, serialization/export/cloud boundaries; read API remains immutable in-memory projection only; read API does not serialize/export/write files/open sockets; read API does not execute lifecycle commands; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Local refusal executor proof returns controlled refusals/static acknowledgements without executing commands; refused UI binding, runtime/lifecycle execution, command dispatcher, decision/order, live/account/secret, serialization/export/cloud attempts remain non-executed; read API remains immutable in-memory projection only; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Service snapshot history contract keeps a bounded immutable in-memory history of already-built read API evidence; history does not collect in background, run loops, serialize/export/write files/open sockets, or execute commands; refusal executor proof remains non-executing; read API remains immutable in-memory projection only; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. BLOK B local runtime service wrapper is contract-complete for static-local evidence; closure audit aggregates service snapshot, boundary matrix, lifecycle command contract, read API, read API boundary/no-export matrix, refusal executor proof, and bounded in-memory history; closure audit confirms ready_for_block_c=True; closure audit keeps ready_for_ui_runtime_integration=False, ready_for_decision_engine=False, ready_for_export=False, ready_for_live=False; integration gate remains blocked; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter; next block should be BLOK C — UI READ-ONLY BINDING.",
        ...
        "portfolio_positions_trades": {
            ...
            "gaps": [
                ...
                "Paper fills produce deterministic trades/positions and basic realized PnL for long closes without live exchange/order/account side effects. Local runtime service wrapper boundary/no-loop matrix refuses runtime loop, scheduler/worker/background, UI binding, controller, decision, export/cloud, live and adapter boundaries; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Lifecycle command contract allows only local/static/single-shot introspection/composition commands; runtime loop, scheduler/worker/background, UI binding, controller, decision, export/cloud, live and adapter commands remain refused; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Local read API boundary/no-export matrix refuses UI binding, runtime/lifecycle execution, command dispatcher, decision/order, live/account/secret, serialization/export/cloud boundaries; read API remains immutable in-memory projection only; read API does not serialize/export/write files/open sockets; read API does not execute lifecycle commands; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Local refusal executor proof returns controlled refusals/static acknowledgements without executing commands; refused UI binding, runtime/lifecycle execution, command dispatcher, decision/order, live/account/secret, serialization/export/cloud attempts remain non-executed; read API remains immutable in-memory projection only; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. Service snapshot history contract keeps a bounded immutable in-memory history of already-built read API evidence; history does not collect in background, run loops, serialize/export/write files/open sockets, or execute commands; refusal executor proof remains non-executing; read API remains immutable in-memory projection only; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter. BLOK B local runtime service wrapper is contract-complete for static-local evidence; closure audit aggregates service snapshot, boundary matrix, lifecycle command contract, read API, read API boundary/no-export matrix, refusal executor proof, and bounded in-memory history; closure audit confirms ready_for_block_c=True; closure audit keeps ready_for_ui_runtime_integration=False, ready_for_decision_engine=False, ready_for_export=False, ready_for_live=False; integration gate remains blocked; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter; next block should be BLOK C — UI READ-ONLY BINDING.",
    ...
    runtime_service_gap = (
        "BLOK B local runtime service wrapper is single-shot/static-local; "
        "wrapper can compose local scenario result, bundle, read model, preflight and integration gate; "
        "local snapshot read API exposes only immutable in-memory summary fields; "
        "read API does not serialize/export/write files/open sockets; "
        "read API does not execute lifecycle commands; "
        "runtime loop, scheduler/worker/background, UI binding, controller, decision, export/cloud, live and adapter commands remain refused; "
        "wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; "
        "no decision engine; no export/cloud/serialization; no generated decisions/orders; "
        "no real market adapter/fetch; no testnet/sandbox adapter; "
        "existing dry-run decision artifact remains context-only/static-local and bundle boundary/export refusal still refuses file export, serialization export, cloud sink, external export, and engine handoff; "
        "integration gate still blocks real UI/runtime integration; "
        "service snapshot history contract keeps a bounded immutable in-memory history of already-built read API evidence; history does not collect in background, run loops, serialize/export/write files/open sockets, or execute commands; refusal executor proof remains non-executing; read API remains immutable in-memory projection only; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter; BLOK B local runtime service wrapper is contract-complete for static-local evidence; closure audit aggregates service snapshot, boundary matrix, lifecycle command contract, read API, read API boundary/no-export matrix, refusal executor proof, and bounded in-memory history; closure audit confirms ready_for_block_c=True; closure audit keeps ready_for_ui_runtime_integration=False, ready_for_decision_engine=False, ready_for_export=False, ready_for_live=False; integration gate remains blocked; wrapper remains single-shot/static-local; no app runtime loop; no UI binding; no controller handoff; no decision engine; no export/cloud/serialization; no generated decisions/orders; no real market adapter/fetch; no testnet/sandbox adapter; BLOK C now maps PreviewReadOnlyBindingSnapshot into controlled read-only UI state values copied from static-local BLOK B closure evidence; BLOK C now has a read-only PySide bridge preflight for blockCReadOnlyBindingState; bridge exposes controlled read-only state as copy-on-read QVariantMap; bridge state passes the no-action boundary matrix; BLOK C QML panel now consumes controlled read-only UI state values with safe blocked/false/none/zero fallbacks; BLOK C now has a read-only UI state boundary/no-action matrix; matrix refuses action handlers, command dispatch, lifecycle execution, runtime loop, scheduler/worker, order generation/submission, decision/controller paths, export/cloud, live/testnet/account/secret boundaries; source smoke confirms controlled QML value consumption for BLOK B closure / BLOK C binding; values originate from PreviewReadOnlyBindingSnapshot via controlled UI state; controlled UI state remains static-local and read-only; state does not expose commands/actions/export/live/testnet/account/secret handles; QML/source proof remains read-only; no actions, command dispatch, lifecycle execution, runtime loop, export/cloud, live/testnet/account/secret paths are exposed; UI proof does not start runtime loop, execute commands, submit orders, serialize/export, fetch live/testnet data, read accounts/secrets, or mutate runtime state; integration gate remains blocked; ready_for_ui_runtime_integration remains false; next step should be bridge refusal/negative controls or read-only bridge smoke in PySide-enabled CI, still without actions."
    )
    read_model_gap = (
        ...
        "no file export, no serialization export, no cloud sink, no external export; no export/cloud/serialization; market context "
