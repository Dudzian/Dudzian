"""Walidacja paczki obserwowalności Stage6 wraz z podpisem HMAC."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Weryfikuje integralność paczki obserwowalności Stage6.",
    )
    parser.add_argument("bundle", help="Ścieżka do archiwum ZIP paczki obserwowalności")
    parser.add_argument(
        "--manifest",
...
def run(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        verifier = ObservabilityBundleVerifier(bundle_path, manifest)
